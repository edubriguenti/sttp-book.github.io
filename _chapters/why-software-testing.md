...
Let's suppose we have this customer which wants that given a list of numbers, the software should return the smallest and the largest number in this list. 
